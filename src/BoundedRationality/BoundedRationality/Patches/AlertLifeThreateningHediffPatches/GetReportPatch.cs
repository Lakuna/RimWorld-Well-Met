...
namespace Lakuna.BoundedRationality.Patches.AlertLifeThreateningHediffPatches {
	[HarmonyPatch(typeof(Alert_LifeThreateningHediff), nameof(Alert_LifeThreateningHediff.GetReport))]
