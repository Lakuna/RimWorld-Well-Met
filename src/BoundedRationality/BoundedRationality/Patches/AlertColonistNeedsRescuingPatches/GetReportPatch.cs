...
namespace Lakuna.BoundedRationality.Patches.AlertColonistNeedsRescuingPatches {
	[HarmonyPatch(typeof(Alert_ColonistNeedsRescuing), nameof(Alert_ColonistNeedsRescuing.GetReport))]
