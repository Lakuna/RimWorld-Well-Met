...
namespace Lakuna.BoundedRationality.Patches.AlertMajorOrExtremeBreakRiskPatches {
	[HarmonyPatch(typeof(Alert_MajorOrExtremeBreakRisk), nameof(Alert_MajorOrExtremeBreakRisk.GetReport))]
