...
namespace Lakuna.WellMet.Patches.WidgetsPatches {
	...
	internal static class InfoCardButtonFactionPatch {
		[HarmonyPrefix]
		private static bool Prefix(Faction faction) => KnowledgeUtility.IsInformationKnownFor(InformationCategory.Advanced, faction, InformationTypeCategory.Control);
	}
}
#endif
