...
namespace Lakuna.WellMet.Patches.WidgetsPatches {
	...
	internal static class InfoCardButtonThingPatch {
		[HarmonyPrefix]
		private static bool Prefix(Thing thing) => !(thing is Pawn pawn) || KnowledgeUtility.IsInformationKnownFor(InformationCategory.Advanced, pawn, InformationTypeCategory.Control);
	}
}
